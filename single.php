  ...
  <section class="work">
    ...
    <div class="work__ex">
      <div class="work__flex">
        <h3 class="work__subTitle fadeIn">サイトURL</h3>
        <p class="work__content fadeIn"><?php echo CFS()->get('url'); ?></p>
      </div>
      <div class="work__flex">
      ...
      <div class="work__flex">
        <h3 class="work__subTitle fadeIn">苦戦した点</h3>
        <p class="work__content fadeIn"><?php echo CFS()->get('good-bad'); ?></p>
      </div>
      <div class="work__flex">
    ...
    <div class="fullPage">
      <div class="fullPage__flex">
        <?php $value = get_post_meta($post->ID, 'full_img_1', true);?>
        <?php if(empty($value)):?>
        <?php else:?>
        ...
        <?php endif;?>
        <?php $value = get_post_meta($post->ID, 'full_img_2', true);?>
        <?php if(empty($value)):?>
        <?php else:?>
